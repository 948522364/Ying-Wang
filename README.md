...
### 4. 数据收集方法
- **数据来源**: 数据集来源于公开的个人薪资调查。相关资源网站为[statlearning](https://www.statlearning.com/resources-python)。
...
### 1. 教育程度与工资的关系
为了更好地理解数据的特征，我们展示了 **教育程度与工资的关系** 柱状图：
...
- PDF 等图片模板：在这个任务的最开始我用PDF制作了相关图片以增强美观性，也让整个项目的主题更加清晰可见。
